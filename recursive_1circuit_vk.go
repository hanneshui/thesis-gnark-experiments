...
type OuterCircuit_oneInner_vk[FR emulated.FieldParams, G1El algebra.G1ElementT, G2El algebra.G2ElementT, GtEl algebra.GtElementT] struct {
...
func (c *OuterCircuit_oneInner_vk[FR, G1El, G2El, GtEl]) Define(api frontend.API) error {
...
func Compute_Outer_1Inner_vk(innerCcs constraint.ConstraintSystem, innerVK groth16.VerifyingKey, innerWitness witness.Witness, innerProof groth16.Proof) (groth16.Proof, groth16.VerifyingKey, witness.Witness) {
	//compute inner proof.
	...
	outerAssignment := &OuterCircuit_oneInner_vk[sw_bls12377.ScalarField, sw_bls12377.G1Affine, sw_bls12377.G2Affine, sw_bls12377.GT]{
		InnerWitness: circuitWitness,
		Proof:        circuitProof,
		VerifyingKey: circuitVk,
	}
	outerCircuit := &OuterCircuit_oneInner_vk[sw_bls12377.ScalarField, sw_bls12377.G1Affine, sw_bls12377.G2Affine, sw_bls12377.GT]{
